 ...
 */
export const scanSnapshotUsage = <ThrowOnError extends boolean = false>(options: Options<ScanSnapshotUsageData, ThrowOnError>): RequestResult<ScanSnapshotUsageResponses, unknown, ThrowOnError> => (options.client ?? client).post<ScanSnapshotUsageResponses, unknown, ThrowOnError>({ url: '/api/v1/repositories/{shortId}/snapshots/{snapshotId}/usage/scan', ...options });

/**
 * Compares two snapshots' recorded usage trees to show what grew, shrank, appeared, or disappeared
 */
export const getSnapshotUsageDiff = <ThrowOnError extends boolean = false>(options: Options<GetSnapshotUsageDiffData, ThrowOnError>): RequestResult<GetSnapshotUsageDiffResponses, unknown, ThrowOnError> => (options.client ?? client).get<GetSnapshotUsageDiffResponses, unknown, ThrowOnError>({ url: '/api/v1/repositories/{shortId}/snapshots/{snapshotId}/usage/diff', ...options });
